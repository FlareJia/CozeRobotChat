...
"""autogenerated by genpy from kuavo_audio_player/playmusicRequest.msg. Do not edit."""
import codecs
import sys
...
class playmusicRequest(genpy.Message):
  _md5sum = "b2d09829452828247b2631028a949bf3"
  _type = "kuavo_audio_player/playmusicRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string music_path
"""
  __slots__ = ['music_path']
  _slot_types = ['string']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.music_path = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.music_path = str[start:end]
      return self
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from kuavo_audio_player/playmusicResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class playmusicResponse(genpy.Message):
  ...
  _type = "kuavo_audio_player/playmusicResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class playmusic(object):
  _type          = 'kuavo_audio_player/playmusic'
  _md5sum = '2b45fccbddec6f75379e3c0de524323f'
