...
(cl:in-package musicplayer_pkg-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <playmusic-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'playmusic-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name musicplayer_pkg-srv:<playmusic-request> is deprecated: use musicplayer_pkg-srv:playmusic-request instead.")))

(cl:ensure-generic-function 'music_number-val :lambda-list '(m))
(cl:defmethod music_number-val ((m <playmusic-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader musicplayer_pkg-srv:music_number-val is deprecated.  Use musicplayer_pkg-srv:music_number instead.")
  (music_number m))

(cl:ensure-generic-function 'volume-val :lambda-list '(m))
(cl:defmethod volume-val ((m <playmusic-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader musicplayer_pkg-srv:volume-val is deprecated.  Use musicplayer_pkg-srv:volume instead.")
  (volume m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<playmusic-request>)))
  ...
  "musicplayer_pkg/playmusicRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'playmusic-request)))
  "Returns string type for a service object of type 'playmusic-request"
  "musicplayer_pkg/playmusicRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <playmusic-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'playmusic-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name musicplayer_pkg-srv:<playmusic-response> is deprecated: use musicplayer_pkg-srv:playmusic-response instead.")))

(cl:ensure-generic-function 'success_flag-val :lambda-list '(m))
(cl:defmethod success_flag-val ((m <playmusic-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader musicplayer_pkg-srv:success_flag-val is deprecated.  Use musicplayer_pkg-srv:success_flag instead.")
  (success_flag m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<playmusic-response>)))
  ...
  "musicplayer_pkg/playmusicResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'playmusic-response)))
  "Returns string type for a service object of type 'playmusic-response"
  "musicplayer_pkg/playmusicResponse")
